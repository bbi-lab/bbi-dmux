...
params.lims_sample_sheet = 'no_input'
params.max_cores = 16
...
if (params.help) {
    ...
    log.info '    params.lims_sample_sheet = PATH/TO/FILE    Path to sample sheet generated by BAT-lab lims. Default is {no_input}.'
    ...
    log.info '    --generate_samplesheets=false              Add this to generate the necessary samplesheet from the BBI universal input sheet. Default is false'    
    log.info ''   
...
process lims_to_samplesheet {

    input:
        file insamp from Channel.fromPath(params.lims_sample_sheet)

    output:
        file "*sheet.csv" into lims_sample_sheet_out
    ...
    lims2samplesheet_csv.py -i $params.lims_sample_sheet
...
process generate_sheets {
    ...
    input:
        ...
        file insamp from lims_sample_sheet_out
    ...
    generate_sample_sheets.py ${insamp}
    """
}
...
process check_sample_sheet {
    ...
    output:
        ...
        file "*.csv" into sample_sheet_file1
        file "*.csv" into sample_sheet_file2
        file "*.csv" into sample_sheet_file3
        file "*.csv" into sample_sheet_file4
        file "*.csv" into sample_sheet_file5
